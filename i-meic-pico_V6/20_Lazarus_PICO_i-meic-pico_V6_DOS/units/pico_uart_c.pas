...
*)
procedure uart_write_blocking(var uart:TUART_Registers; var src:array of byte;len:longWord);
...
procedure uart_read_blocking(var uart:TUART_Registers; var dst : array of byte; len : longWord);
